...
import type { PlaylistSegment } from "./types.js";
...
export function parsePlaylistSegments(playlistText: string) {
  ...
  for (let index = 0; index < lines.length; index += 1) {
    ...
    if (!uri || Number.isNaN(duration)) continue;
...
export function buildVodPlaylist(segments: PlaylistSegment[]) {
...
export function inferContentTypeFromKey(key: string) {
